...
```{r}
# taylor swift
arimax1 <- auto.arima(singers_ts_split$train[,2], lambda="auto", xreg=singers_ts_split$train[,3])
arimax1_fc <- forecast(arimax1, h=outofsample, xreg=singers_ts_split$train[,3])
