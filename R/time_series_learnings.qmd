...
Tests if time series data is captured in residuals, et, where et = yhat - y.

If time series data is captured in residuals (et), it is not being captured in the model (yhat). Hence, we have to adjust our model to capture the time series data.
