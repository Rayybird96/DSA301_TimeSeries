...
We will be building basic *autoregressive intergrated moving average (ARIMA)* models for both models, to act as a benchmark against more complex models.
The green vairables interact with one another, hence can be modelled wih *vectorised auto regression (VAR)* and *vector error correction model (VECM)*.
